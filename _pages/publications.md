...
**Abney, D.H.**, Suanda, S.H., Smith, L.B., Yu, C. (in press). What are the building blocks of parent-infant coordinated attention in free-flowing interaction? <i>Infancy<i>. [PDF](http://drewabney.github.io/files/Abneyetal_2020.pdf) [Preprint](http://drewabney.github.io/files/Abneyetal_2020_Infancy_preprint.pdf)
...
Xu, L., de Barbaro, K., **Abney, D.H.**, Cox, R. (2020). Finding structure in time: Visualizing and analyzing behavioral time series. <i>Frontiers in Developmental Psychology<i>. [PDF](http://drewabney.github.io/files/Xuetal_2020.pdf) [Github Repo](https://github.com/findstructureintime/Time-Series-Analysis)
